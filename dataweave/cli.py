...
def main():
    parser = argparse.ArgumentParser(description="CLI tool for managing server and RabbitMQ tasks")
    subparsers = parser.add_subparsers(help='commands')

    # Runserver command
    runserver_parser = subparsers.add_parser('runserver', help='Run the server')
    runserver_parser.add_argument('--workers', type=int, default=1, help='Number of workers (default: 1)')
    runserver_parser.add_argument('--port', type=int, default=8000, help='Port to run the server on (default: 8000)')
    ...
    runconsumer_parser.add_argument('--rabbit-mq', default='localhost:15672', help="RabbitMQ server address (default: 'localhost:15672')")
    runconsumer_parser.add_argument('--queue', default='products', help="Queue name (default: 'products')")
    ...
    ingest_parser.add_argument('--rabbit-mq', default='localhost:15672', help="RabbitMQ server address (default: 'localhost:15672')")
    ingest_parser.add_argument('--queue', default='products', help="Queue name (default: 'products')")
    ingest_parser.set_defaults(func=ingest)

    # Create-db command
    create_db_parser = subparsers.add_parser('create-db', help='Create the database')
    create_db_parser.add_argument('--db-url', default='sqlite:///products.db', help='Database URL')
    ...
    delete_db_parser.add_argument('--db-url', default='sqlite:///products.db', help='Database URL')
